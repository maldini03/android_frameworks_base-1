...
package com.android.systemui.hyper.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.hyper.header.STATUS_BAR_HEADER_UPDATE";
