...
package com.android.systemui.zproject.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.zproject.header.STATUS_BAR_HEADER_UPDATE";
